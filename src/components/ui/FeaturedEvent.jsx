...
export const FeaturedEvent = ({ title, image, location, startTime }) => {
  return (
    <div className="zoomin animation-duration-100 p-card flex flex-column md:flex-row max-w-1200 w-full md:h-20rem  select-none highlighted-event shadow-6 bg-teal-900">
      <div className="w-full md:w-6 m-4">
        <h1 className="text-6xl text-white uppercase">featured</h1>
